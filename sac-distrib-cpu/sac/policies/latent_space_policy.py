...
class LatentSpacePolicy(NNPolicy, Serializable):
    ...
    def get_actions(self, observations):
        ...
        if self._fixed_h is not None:
            ...
            actions = self._sess.run(#tf.get_default_session().run(
    ...
    def log_diagnostics(self, iteration, batch):
        ...
        feeds = { self._observations_ph: batch['observation'] }
        raw_actions, actions, log_pis = self._sess.run(# tf.get_default_session().run(
