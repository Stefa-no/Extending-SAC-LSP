...
class NNVFunction(MLPFunction):
    ...
    def __init__(self, env_spec, hidden_layer_sizes=(100, 100)):
        ...
        super(NNVFunction, self).__init__(
            'vf', (self._obs_pl,), hidden_layer_sizes, output_nonlinearity=tf.nn.softmax)
...
class NNQFunction(MLPFunction):
    def __init__(self, env_spec, hidden_layer_sizes=(100, 100)):
        ...
        super(NNQFunction, self).__init__(
            'qf', (self._obs_pl, self._action_pl), hidden_layer_sizes, output_nonlinearity=tf.nn.softmax)  #out_nonlinearity added to try the c51 approach
