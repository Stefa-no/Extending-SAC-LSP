...
ENV_PARAMS = {
    ...
    'ant-resume-training': {  # 8 DoF
        ...
        'snapshot_gap': 1000,
	# TO CHANGE LOW LEVEL POLICY PATH
        'low_level_policy_path': [
        #    '/users/pgrad/gattos/sac/sac/data/swimmer-experiment-lsp/itr_6000.pkl',
            '/users/pgrad/gattos/sac/sac/data/ant-crossmaze-hierarchy/itr_10000.pkl',
